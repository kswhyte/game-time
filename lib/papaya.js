...
//new prototypes for the rigth and left sides of the paddle

Papaya.prototype.left60 = function() {
  this.speedY = -this.speedY;
  this.speedX = (-this.speedX * 0.6);
};

Papaya.prototype.left45 = function() {
  this.speedY = -this.speedY;
  this.speedX = -this.speedx;
};

Papaya.prototype.right45 = function() {
  this.speedY = -this.speedY;
  this.speedX = this.speedX;
};

Papaya.prototype.right60 = function() {
  this.speedY = -this.speedY;
  this.speedX = this.speedX * 0.6;
};
