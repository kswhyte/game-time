...
Jungle.prototype.detectJungleBoundaries = function() {
  ...
  if(this.papaya.y + this.papaya.speedY > this.height - this.papaya.papayaRadius || this.papaya.y + this.papaya.speedY < this.papaya.papayaRadius) {
...
//   if (this.papaya.y + this.papaya.speedY > this.height - this.papaya.papayaRadius) {
