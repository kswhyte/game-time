...
//     if ((papaya.x + papaya.width > paddle.x + 20) && (papaya.x + papaya.width < (paddle.x + 40))){
//       papaya.left60();
//     }
//     if ((papaya.x + papaya.width > paddle.x) && ((papaya.x + papaya.width) < (paddle.x + 20))) {
//       papaya.left45();
//     }
//     if ((papaya.x > paddle.x + 60) && ((papaya.x + papaya.width) < (paddle.x + 80))) {
//       papaya.right60();
//     }
//     if (papaya.x > paddle.x + 80 && papaya.x + papaya.width < paddle.x + paddle.width){
//         papaya.right45();
//       }
...
// =======
// >>>>>>> 662e4460af4742279ac3af07b1be14fe7d63df31
// =======
// >>>>>>> dd226337b000e647eba3b6f0b831886e58eb9e5c
...
Jungle.prototype.detectPaddle = function(paddle) {
  ...
  if(papaya.isCollidingIntoTopOf(paddle)) {
  // || papaya.isCollidingIntoLeftOf(paddle)
  // || papaya.isCollidingIntoRightOf(paddle)) {
    papaya.speedY = -papaya.speedY;
