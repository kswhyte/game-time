...
Jungle.prototype.detectBlocks = function() {
  ...
  this.blockSetup.forEach(function(block) {
      if (papaya.isCollidingIntoTopOf(block)) {
        this.reversePapayaVerticalAndDestroyBlock(papaya, block);
      } else if (papaya.isCollidingIntoRightOf(block)) {
        this.reversePapayaHorizontalAndDestroyBlock(papaya, block);
...
Jungle.prototype.reversePapayaHorizontalAndDestroyBlock = function (papaya, block) {
  this.reverseX(papaya);
  this.alterBlockStatus(block);
};

Jungle.prototype.reversePapayaVerticalAndDestroyBlock = function (papaya, block) {
  this.reverseY(papaya);
  this.alterBlockStatus(block);
};
